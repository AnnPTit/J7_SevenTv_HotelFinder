...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .and().authorizeHttpRequests().requestMatchers("/api/admin/account/resetPassword/{id}").hasRole("ADMIN")
                .and().authorizeHttpRequests().requestMatchers("/api/admin/account/delete/{id}").hasRole("ADMIN")
                .and().authorizeHttpRequests().requestMatchers("/api/admin/account//update/{id}").hasRole("ADMIN")
                .and().authorizeHttpRequests().requestMatchers("/api/admin/account/changePassword/{id}").permitAll()
